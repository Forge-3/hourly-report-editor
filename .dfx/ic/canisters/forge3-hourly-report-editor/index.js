...
import { idlFactory } from './forge3-hourly-report-editor.did.js';
export { idlFactory } from './forge3-hourly-report-editor.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FORGE3_HOURLY_REPORT_EDITOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./forge3-hourly-report-editor.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the forge3-hourly-report-editor canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./forge3-hourly-report-editor.did.js")._SERVICE>}
 */
export const forge3_hourly_report_editor = createActor(canisterId);
